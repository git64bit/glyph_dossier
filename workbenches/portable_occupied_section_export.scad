    //////////////////////////////////////////////////////////////////////
    // LibFile: portable_occupied_section_export.scad
    // Project: Glyph Dossier
    // FileGroup: Executable Occupancy Workbench
    // FileSummary: Exports one occupied record by row-major ordinal.
    //////////////////////////////////////////////////////////////////////
...
portable_bounds_line_width = 1.5;
    ...
    /* [Selected occupied part: zero based] */
    portable_selected_occupied_ordinal = 0;

    /* [Hidden] */
    portable_show_empty_occupancy_cells = false;
    portable_occupancy_overlay_depth = 0.5;
    portable_render_mode = "occupied_export";
