//////////////////////////////////////////////////////////////////////
// LibFile: portable_family_comparison.scad
// Project: Glyph Dossier
// FileGroup: Executable Multi-Family Workbench
// FileSummary: Same selected glyph across all stored families.
//////////////////////////////////////////////////////////////////////

portable_set_id_selected = "LIBERATION_SANS_REGULAR_R1";
...
portable_render_mode = "family_comparison";
portable_target_height = 120;
portable_extrusion_depth = 6;
portable_family_spacing = 170;
