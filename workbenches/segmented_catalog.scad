//////////////////////////////////////////////////////////////////////
// LibFile: segmented_catalog.scad
// Project: Glyph Dossier
// FileGroup: Executable Segmented Workbench
// FileSummary: Visible, blank, and unsupported mapping states.
//////////////////////////////////////////////////////////////////////
...
/* [View] */
segmented_catalog_view = "source_state"; // [source_state,normalized_profile,report]

/* [Geometry] */
segmented_target_height = 600;
segmented_extrusion_depth = 6;
segmented_show_inactive = true;
segmented_show_frame = true;
segmented_frame_line_width = 1.5;

/* [Hidden] */
segmented_render_mode =
    segmented_catalog_view == "normalized_profile"
    ? "normalized_profile"
    : segmented_catalog_view == "report"
    ? "report_only"
    : "source_state";
